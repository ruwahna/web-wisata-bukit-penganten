...
const fadeTargets = document.querySelectorAll(
  '.mengenal-kiri, .mengenal-card, .about-section, .about-image-row img, .about-banner img, .about-komitmen-card, .about-lokasi-wrap, .about-lokasi-map, .about-lokasi-info, .about-lokasi-info li, .testimoni-gallery-section, .testimoni-photo, .testimoni-review-section, .review-card, .review-cta, .kontak-panel'
);
